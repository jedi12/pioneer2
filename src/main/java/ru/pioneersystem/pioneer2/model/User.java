...
public class User {
    ...
    private boolean createOwnGroup;
    ...
    public boolean isCreateOwnGroup() {
        return createOwnGroup;
    }

    public void setCreateOwnGroup(boolean createOwnGroup) {
        this.createOwnGroup = createOwnGroup;
    }
